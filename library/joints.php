...
function joints_scripts_and_styles() {
  ...
  if (!is_admin()) {
    ...
    wp_enqueue_script( 'owl-js', get_template_directory_uri() . '/bower_components/OwlCarousel/owl-carousel/owl.carousel.min.js', array( 'jquery' ), $theme_version, true );
    wp_enqueue_script( 'waypoints', get_template_directory_uri() . '/bower_components/jquery-waypoints/waypoints.min.js', array( ), $theme_version, true );
      
   
    // register main stylesheet
    wp_enqueue_style( 'joints-stylesheet', get_template_directory_uri() . '/library/css/style.css', array(), $theme_version, 'all' );
    wp_enqueue_style( 'nadando-stylesheet', get_template_directory_uri() . '/library/css/nadando.css', array(), $theme_version, 'all' );
    wp_enqueue_style( 'nadando2-stylesheet', get_template_directory_uri() . '/library/css/nadando2.css', array(), $theme_version, 'all' );
    wp_enqueue_style( 'owl-stylesheet', get_template_directory_uri() . '/bower_components/OwlCarousel/owl-carousel/owl.carousel.css', array(), $theme_version, 'all' );
    ...
    wp_enqueue_script( ' jquery.matchHeight-min-js', get_template_directory_uri() . '/library/js/ jquery.matchHeight-min.js', array( 'jquery' ), $theme_version, true );
    wp_enqueue_script( 'joints-js', get_template_directory_uri() . '/library/js/scripts.js', array( 'jquery' ), $theme_version, true );
    wp_enqueue_script( 'mscript-js', get_template_directory_uri() . '/library/js/min/mScript-ck.js', array( 'jquery' ), $theme_version, true );
